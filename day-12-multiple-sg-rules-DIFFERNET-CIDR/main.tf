# here multiple port and different source as you can see we used for loop and dynamic ingreess to avoid long code
#var allowed prt select all written port
#ingress.key calls port
#[ingress.value] calles value or CIDR source
